...
/* ========== الوظائف الرئيسية ========== */
@@ -48,61 +54,78 @@ async function handleSignUp(email, password, name, role) {
...
@@ -48,61 +54,78 @@ async function handleSignUp(email, password, name, role) {
    ...
    if (authData?.user) {
      ...
      // ج. نتأكد من تسجيل الدخول فورًا بدون انتظار بريد تأكيد
...
@@ -118,57 +141,64 @@ async function checkAuth() {
      .single();
